...
# └──────────────────────────────────────────────────────────────────────────────┘
TOP_UP = "дополнить"
# Сколько примеров держит карточка. Решение владельца 29.08.2026: «двух достаточно;
# если меньше двух — догнать до двух». Столько же просит и промпт полной пересборки
# («Write TWO new examples») — число теперь одно на оба пути, а не два разных.
ПРИМЕРОВ_В_КАРТОЧКЕ = 2
MAX_ATTEMPTS = 3
