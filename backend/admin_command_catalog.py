...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ...
    ('pools', '📦 Пулы и отчёты', [
        ...
        {
            "cmd": '/admin_pin_audit',
            "desc": 'Перепроверяет рамку ответа у всех живых заданий «Finde im Bild»: два независимых прохода vision по каждой картинке — сошлись, рамка переписывается, разошлись, задание снимается. Лечит боксы, обводящие не тот предмет (из-за них задание невозможно пройти).',
            "args": 'нет аргументов',
            "example": '/admin_pin_audit',
        },
        {
            "cmd": '/admin_aq_pool',
