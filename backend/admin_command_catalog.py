...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ...
    ('schedule', '🗓 Планировщик, рассылки, здоровье', [
        ...
        {
            "cmd": '/shortcut_runs',
            "desc": 'Мониторинг запусков «Ночного Переводчика»: последние обращения (время/юзер/решение/в окне/грейс/установки), сводка и аномалии (прошли вне окна — возможный косяк).',
            "args": '[дней=7]',
