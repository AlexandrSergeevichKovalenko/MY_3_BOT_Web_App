...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ...
    ('dict', '📖 Словарь и слова', [
        ...
        },
        {
            ...
            "desc": 'Интерактивный разбор «мусора» пула — слова, которые GPT не смог собрать в карточку 3 раза подряд и которые выпали из ночной очереди (выдуманные композиты, опечатки, обрывки; спрос почти всегда 0). Все отмечены галочкой на удаление: отожми те, что оставить, и жми «Удалить отмеченные». Тот же интерактивный список приходит сам раз в неделю (Вс 09:00), а число в карантине — строкой «🗑 В карантине» в утреннем отчёте «Ночной добор словаря».',
            "args": 'нет аргументов',
