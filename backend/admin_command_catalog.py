...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ('access', '👥 Доступ и пользователи', [
        ...
        },
        {
            ...
            "args": 'нет аргументов — состояние двери с кнопками; cap <N> — поставить потолок (0 = снять, дверь открыта всем); ochered — кто ждёт и с какими номерами; demo — показать тексты, которые увидит человек, никого не трогая.',
            "example": '/dver cap 50',
        },
        {
            "cmd": '/zhaloby',
