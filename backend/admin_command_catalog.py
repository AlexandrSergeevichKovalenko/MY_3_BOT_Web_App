...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ...
    ('pools', '📦 Пулы и отчёты', [
        ...
        },
        {
            ...
            "desc": 'Присылает карточки приёмки «Finde im Bild»: картинка с нарисованной зелёной рамкой ответа + кнопки «Одобрить» / «Забраковать». Новые задания создаются сразу на проверке и людям не уходят, пока не одобришь; «Забраковать» снимает задание и генерирует замену.',
