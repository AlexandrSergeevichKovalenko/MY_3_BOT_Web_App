...
ADMIN_COMMAND_TOPICS: list[tuple[str, str, list[dict]]] = [
    ...
    ('dict', '📖 Словарь и слова', [
        ...
        },
        {
            ...
            "desc": 'Полный список «мусора» пула — слова, которые GPT не смог собрать в карточку 3 раза подряд и которые выпали из ночной очереди (выдуманные композиты, опечатки, обрывки; спрос почти всегда 0). Число из этого списка также показывается строкой «🗑 В карантине» в утреннем отчёте «Ночной добор словаря».',
            "args": 'нет аргументов',
