...
function fitOne(root) {
  ...
  //
  // Признак «своя раскладка» — либо явное объявление `data-wide`, либо просто наличие
  // рабочей области `.ans-r-work`: карточка, у которой есть задание и мишени, раскладывается
