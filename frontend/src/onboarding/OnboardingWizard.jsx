      ...
      return (
        <div className="ob-stub">
          ...
          <ul className="ob-list">
            ...
            <li>
              <b>⭐ Иконка быстрого словаря</b> на экране телефона — нажал и сразу получил
              полный разбор слова (перевод, синонимы, антонимы, примеры, артикль) и сохранил
              одной кнопкой. Как переводчик, только полезнее. <i>(настроим отдельно)</i>
            </li>
          </ul>
