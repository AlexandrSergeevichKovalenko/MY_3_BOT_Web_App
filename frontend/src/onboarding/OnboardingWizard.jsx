...
const STEPS = [
  ...
  { id: 'howto',      title: 'Что умеет бот 🎬',            kind: 'info' },
...
function StepBody(props) {
  ...
  switch (bodyKey) {
    ...
    case 'howto':
      return (
        <div className="ob-stub">
          <p className="ob-lead">Вот главное, что бот делает для тебя:</p>
          <ul className="ob-list">
            <li>
              <b>📋 Задания каждый день.</b> Бот сам присылает небольшие задания —
              переводы, тесты, мини-игры. Открываешь и решаешь прямо здесь, в приложении.
            </li>
            <li>
              <b>📖 Твой словарь.</b> Сохраняешь слова, которые учишь. Бот сам напомнит
              их повторить в нужный момент — так они запоминаются надолго, а не забываются
              на следующий день.
            </li>
            <li>
              <b>🎮 Тренировки и дуэли.</b> Короткие игры на грамматику: артикли
              der/die/das, окончания, вопросы. Можно играть одному или вызвать другого
              ученика на дуэль — кто быстрее и без ошибок.
            </li>
            <li>
              <b>🤖 Учитель с ИИ.</b> Не понял правило? Спроси своими словами — получишь
              простое объяснение с примерами.
            </li>
          </ul>
          <p className="ob-lead ob-muted-note">Пошаговые видео — в разделе «🎬 Как пользоваться».</p>
        </div>
      );
    case 'keyboard':
      return (
