    ...
    return (
      <div className="wa">
        <div className="wa-final">
          ...
          {/* Раньше здесь обещали письмо в чат с итогом. Владелец 31.08.2026 письмо
              отменил: «человек этим процессом не управляет, в его картине мира всё уже
              сделано». Осталось единственное, что человеку вправду нужно знать, —
              что карточки обновятся не мгновенно. Про нашу кухню — ни слова. */}
          {n ? (
            <p className="wa-final-note">
              Карточки в словаре обновятся сами в течение нескольких минут.
            </p>
          ) : null}
        </div>
      </div>
