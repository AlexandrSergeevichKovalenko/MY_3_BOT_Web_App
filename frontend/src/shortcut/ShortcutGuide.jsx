      ...
      <ol className="sc-steps">
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p className="sc-note">📸 За один запуск команда берёт из папки до <b>25</b> скриншотов. Запусков: <b>Pro</b> — 2 в день; на бесплатном — <b>5 пробных</b> всего, чтобы попробовать (дальше на Pro).</p>
