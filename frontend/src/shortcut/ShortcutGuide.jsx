        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <div className="sc-danger">
              <p><b>⏰ Важно: отправка работает только в фиксированные утренние часы — 05:00–09:00.</b> В другое время команда не отправит слова — она просто дождётся своего утреннего времени и уйдёт сама.</p>
