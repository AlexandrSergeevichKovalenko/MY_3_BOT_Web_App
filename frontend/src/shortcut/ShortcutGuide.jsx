  ...
  return (
    <div className="sc-root">
      ...
      <ol className="sc-steps">
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p className="sc-note">На <b>Pro</b> — без ограничений. На бесплатном — до дневного лимита слов (дальше продолжишь на Pro).</p>
            ...
            <ul className="sc-sublist">
              ...
              <li>Найдите установленную команду <b>«Ordner with JSON»</b> и нажмите <b>по центру плитки</b> (не на три точки — просто по центру). Команда запустится.</li>
              <li>Появится окошко — вставьте <b>скопированный код</b> и подтвердите кнопкой под ним.</li>
            </ul>
            <p>Готово ✅ Настройка завершена — переходите к следующему шагу (время запуска ниже).</p>
      ...
      <section className="sc-done">
        ...
        <p>🎬 Видишь немецкое слово в рилсе или чате → <b>поставь на паузу</b> (iPhone делает
          скриншот чуть с задержкой — на паузе точно поймаешь нужный кадр) → нажми свою кнопку
          (действие / двойное касание крышки) → скриншот тихо уходит в альбом «Deutsch Queue».</p>
        <p>⚠️ Работает <b>только</b> эта команда (твоя кнопка). Обычные скриншоты старой
          комбинацией клавиш в эту схему <b>не попадут</b>.</p>
        <p>📂 После пары раз загляни в альбом «Deutsch Queue» — проверь, что скриншоты
          складываются. Складываются — значит всё настроено верно.</p>
        <p>🌙 Утром (в час, что ты выбрал) команда сама всё переведёт → слова придут в личку с
          кнопками сохранения.</p>
      </section>
