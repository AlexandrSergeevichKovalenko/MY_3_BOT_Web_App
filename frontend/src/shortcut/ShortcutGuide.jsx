  ...
  return (
    <div className="sc-root">
      ...
      <ol className="sc-steps">
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p className="sc-note">📸 За один запуск команда берёт из папки до <b>25</b> скриншотов. Запусков: <b>Pro</b> — 2 в день; на бесплатном — <b>3 пробных</b> всего (дальше на Pro).</p>
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p className="sc-why">💡 Зачем: после установки нужно один раз пройти команды вручную. iPhone в первый раз спрашивает разрешение на каждое действие — вы отвечаете <b>«Всегда разрешать»</b>, и дальше всё идёт само, без вопросов. Без этого разового прогона автоматика не заработает.</p>
            ...
            <p>Откройте любую соцсеть (например, <b>Instagram</b>), включите любое видео. Как только на экране появится
              немецкое слово или фраза — <b>поставьте видео на паузу</b> и нажмите свою кнопку (кнопка «Действие»
            ...
            <p>Первый раз iPhone спросит, разрешить ли сохранение: «Не разрешать» / «Разрешить один раз» /
              <b> «Всегда разрешать»</b>. Выберите <b>«Всегда разрешать»</b> — тогда телефон больше не будет
            ...
            <p>Вернитесь в приложение <b>«Команды»</b> (там, где вы устанавливали обе команды), найдите команду
              <b> «Ночной Переводчик»</b> и <b>нажмите по центру плитки</b> (не на три точки в углу — просто по центру).
              Команда запустится, вы это увидите. Она задаст два вопроса:</p>
            <ul className="sc-sublist">
              <li>Разрешить <b>отправку</b> ваших фотографий на обработку? → нажмите <b>«Всегда разрешать»</b>.</li>
              <li>Разрешить <b>удаление</b> обработанных фотографий из альбома? → нажмите <b>«Всегда разрешать»</b> (или «Всегда удалять»).</li>
            </ul>
      ...
      <section className="sc-done">
        ...
        <p>🎬 Видишь немецкое слово в рилсе → <b>поставь на паузу</b> (iPhone делает скриншот
        ...
        <p>📂 Только в <b>первый раз</b> загляни в альбом «Deutsch Queue» и проверь, что скриншоты
          туда складываются. Складываются — значит настроено верно, и больше делать ничего не надо:
          ты просто смотришь любимое, а скриншоты копятся сами.</p>
