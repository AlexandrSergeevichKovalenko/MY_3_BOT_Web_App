      ...
      <ol className="sc-steps">
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p className="sc-note">📸 За одну отправку команда берёт из папки до <b>25</b> фото. <b>В «Полном доступе» — ровно 2 отправки в день</b> (в каждой до 25 фото), в утренние часы. ❗️Очень важно <b>не запускать 3-й раз</b>: эти фото просто удалятся, а перевод не придёт. На бесплатном — <b>5 пробных</b> запусков всего, чтобы попробовать функцию (дальше — в «Полном доступе»).</p>
        ...
        <li className="sc-step">
          ...
          <div className="sc-step-body">
            ...
            <p>Вернитесь в приложение <b>«Команды»</b> (там, где вы устанавливали обе команды), найдите команду
              <b> «Ночной Переводчик»</b> и <b className="sc-key">сделайте короткий тап по центру плитки</b> (коротко нажмите по центру — не на три точки в углу).
              Если команда запустилась, в <b>правом верхнем углу</b> появится индикатор загрузки — это значит, что команда пошла работать. Она задаст два вопроса:</p>
            <ul className="sc-sublist">
