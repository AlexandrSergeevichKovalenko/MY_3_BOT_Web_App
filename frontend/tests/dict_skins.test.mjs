...
// стоит фиксированным слоем, и WebKit сажает её на видимую полосу сам — наш сдвиг
// складывался с его, карточка съезжала вниз и возвращалась. См. разбор трёх попыток
