...
TRANSLATIONS = {
    ...
    # 18.08.2026, тот же класс: в поле перевода лежала немецкая фраза «Ich möchte
    # klären». Страж связей правильно отказался считать её переводом.
    45653: ("Ich möchte das noch einmal präzisieren",
            "Я хотел бы это ещё раз уточнить."),
}
